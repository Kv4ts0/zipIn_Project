...
<body>
    <form action="{{ route('tours.update',['id' => $tour->id]) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="name" id="name" value="{{ $tour->name }}"/>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <td><img width="100px" height="100px" src="/storage/tour/{{$tour->image1}}" alt=""><br><input type="file" name="image1" placeholder="Main Image"></td><hr>
                </div>
                <div class="form-group">
                    <label for="image2">Second Image</label><br>
                    <td><img width="100px" height="100px" src="/storage/tour/{{$tour->image2}}" alt=""><br><input type="file" name="image2" placeholder="Second Image"></td><hr>
                </div>
                <div class="form-group">
                    <label for="image3">Third Image</label><br>
                    <td><img width="100px" height="100px" src="/storage/tour/{{$tour->image3}}" alt=""><br><input type="file" name="image3" placeholder="Third Image"></td><hr>
                </div>
                <div class="form-group">
                    <label for="image4">Fourth Image</label><br>
                    <td><img width="100px" height="100px" src="/storage/tour/{{$tour->image4}}" alt=""><br><input type="file" name="image4" placeholder="Fourth Image"></td><hr>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" id="description" cols="30" style="width: 100%" rows="10">{{ $tour->description }}</textarea>
                </div>
